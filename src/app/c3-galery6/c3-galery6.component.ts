...
@Component({
  selector: 'app-c3-galery6',
  templateUrl: './c3-galery6.component.html',
  styleUrls: ['./c3-galery6.component.css']
})
export class C3Galery6Component implements OnInit {
    slug: string;
    id: any;
    users: any;
...
@Component({
    selector: 'app-single-popup7',
    templateUrl: 'single-popup7.html',
})
export class SinglePopup7 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SinglePopup7>,
