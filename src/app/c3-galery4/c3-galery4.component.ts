...
@Component({
  selector: 'app-c3-galery4',
  templateUrl: './c3-galery4.component.html',
  styleUrls: ['./c3-galery4.component.css']
})
export class C3Galery4Component implements OnInit {
    slug: string;
    id: any;
    users: any;
...
@Component({
    selector: 'app-single-popup5',
    templateUrl: 'single-popup5.html',
})
export class SinglePopup5 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SinglePopup5>,
