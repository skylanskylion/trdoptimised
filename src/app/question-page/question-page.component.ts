...
export class QuestionPageComponent implements OnInit {
 ...
 ngOnInit() {
   this.kp1_model.response_type = 'pre-event'; 
...
//conference
conference_tv : boolean =false;
isconference_tv(){
 this.conference_tv=true;
}
...
enableDisableRuleConf(job) {
 this.toggleconf = !this.toggleconf;
 this.statusconf = this.toggleconf ? 'Enable' : 'Disable';
 this.toggleconf1 =true;
 this.toggleconf2 =true;
 this.toggleconf3 =true;
 this.toggleconf4 =true;
 this.kp1_model.conferencetv='No';
 

}
enableDisableRuleConf1(job) {
 this.toggleconf1 = !this.toggleconf1;
 this.statusconf1 = this.toggleconf1 ? 'Enable' : 'Disable';
 
 this.kp1_model.toggleconf4='No';
...
enableDisableRuleConf2(job) {
 this.toggleconf2 = !this.toggleconf2;
 this.statusconf2 = this.toggleconf2 ? 'Enable' : 'Disable';
 this.toggleconf1 =true;
 this.toggleconf =true;
 this.toggleconf3 =true;
 this.toggleconf4 =true;
...
enableDisableRuleConf3(job) {
 this.toggleconf3 = !this.toggleconf3;
 this.statusconf3 = this.toggleconf3 ? 'Enable' : 'Disable';
...
enableDisableRuleConf4(job) {
 this.toggleconf4 = !this.toggleconf4;
 this.statusconf4 = this.toggleconf4 ? 'Enable' : 'Disable';
 this.toggleconf1 =true;
 this.toggleconf2 =true;
 this.toggleconf3 =true;
 this.toggleconf =true;
 this.kp1_model.conferencetv = 'Yes';

}
//Promos
pro_mo : boolean =false;
ispromo(){
 this.pro_mo =true;
}
togglepromo = true;
...
enableDisableRulePromo(job) {
 this.togglepromo = !this.togglepromo;
 this.statuspromo = this.togglepromo ? 'Enable' : 'Disable';
 this.togglepromo1 =true;
 this.togglepromo2 =true;
 this.togglepromo3 =true;
 this.togglepromo4 =true;
 this.kp1_model.promo='No';
 

}
enableDisableRulePromo1(job) {
 this.togglepromo1 = !this.togglepromo1;
 this.statuspromo1 = this.togglepromo1 ? 'Enable' : 'Disable';
 
 this.kp1_model.togglepromo='No';
...
enableDisableRulePromo2(job) {
 this.togglepromo2 = !this.togglepromo2;
 this.statuspromo2 = this.togglepromo2 ? 'Enable' : 'Disable';
 this.togglepromo1 =true;
 this.togglepromo =true;
 this.togglepromo3 =true;
 this.togglepromo4 =true;
...
enableDisableRulePromo3(job) {
 this.togglepromo3 = !this.togglepromo3;
 this.statuspromo3 = this.togglepromo3 ? 'Enable' : 'Disable';
...
enableDisableRulePromo4(job) {
 this.togglepromo4 = !this.togglepromo4;
 this.statuspromo4 = this.togglepromo4 ? 'Enable' : 'Disable';
 this.togglepromo1 =true;
 this.togglepromo2 =true;
 this.togglepromo3 =true;
 this.togglepromo =true;
 this.kp1_model.promo = 'Yes';

}
//Live streaming
live_streaming : boolean =false;
islive(){
 this.live_streaming =true;
}
togglelive = true;
statuslive = 'Enable'; 
...
enableDisableRuleLive(job) {
 this.togglelive = !this.togglelive;
 this.statuslive = this.togglelive ? 'Enable' : 'Disable';
 this.togglelive1 =true;
 this.togglelive2 =true;
 this.togglelive3 =true;
 this.togglelive4 =true;
 this.kp1_model.live='No';
 

}
enableDisableRuleLive1(job) {
 this.togglelive1 = !this.togglelive1;
 this.statuslive1 = this.togglelive1 ? 'Enable' : 'Disable';
 
 this.kp1_model.togglelive='No';
...
enableDisableRuleLive2(job) {
 this.togglelive2 = !this.togglelive2;
 this.statuslive2 = this.togglelive2 ? 'Enable' : 'Disable';
 this.togglelive1 =true;
 this.togglelive =true;
 this.togglelive3 =true;
 this.togglelive4 =true;
...
enableDisableRuleLive3(job) {
 this.togglelive3 = !this.togglelive3;
 this.statuslive3 = this.togglelive3 ? 'Enable' : 'Disable';
...
enableDisableRuleLive4(job) {
 this.togglelive4 = !this.togglelive4;
 this.statuslive4 = this.togglelive4 ? 'Enable' : 'Disable';
 this.togglelive1 =true;
 this.togglelive2 =true;
 this.togglelive3 =true;
 this.togglelive =true;
 this.kp1_model.live = 'Yes';
...
enableDisableRuleNews(job) {
 this.togglenews = !this.togglenews;
 this.statusnews = this.togglenews ? 'Enable' : 'Disable';
 this.togglenews1 =true;
 this.togglenews2 =true;
 this.togglenews3 =true;
 this.togglenews4 =true;
 this.kp1_model.news='No';
 

}
enableDisableRuleNews1(job) {
 this.togglenews1 = !this.togglenews1;
 this.statusnews1 = this.togglenews1 ? 'Enable' : 'Disable';
 
 this.kp1_model.togglenews='No';
 
 this.togglenews =true;
 this.togglenews2 =true;
 this.togglenews3 =true;
 this.togglenews4 =true;
}
enableDisableRuleNews2(job) {
 this.togglenews2 = !this.togglenews2;
 this.statusnews2 = this.togglenews2 ? 'Enable' : 'Disable';
 this.togglenews1 =true;
 this.togglenews =true;
 this.togglenews3 =true;
 this.togglenews4 =true;
...
enableDisableRuleNews3(job) {
 this.togglenews3 = !this.togglenews3;
 this.statusnews3 = this.togglenews3 ? 'Enable' : 'Disable';
...
enableDisableRuleNews4(job) {
 this.togglenews4 = !this.togglenews4;
 this.statusnews4 = this.togglenews4 ? 'Enable' : 'Disable';
 this.togglenews1 =true;
 this.togglenews2 =true;
 this.togglenews3 =true;
 this.togglenews =true;
 this.kp1_model.news = 'Yes';
}
}
