...
import { WindowRefSubscription } from './WindowRefSubscription';
...
export class SubscriptionPlanPageComponent implements OnInit {
  ...
  constructor(
    ...
    private winRef: WindowRefSubscription
    ) {
  }
  ...
  rzp1:any;
    ...
    addPlan(response:any){
      ...
      this.planService.addPlan(this.payDetails).subscribe(
        responseData => {
        this.response=responseData;
        alert("Payment Successful")
        console.log(responseData)
        this.payment_success= 1;
        this.loginService.setAmount(this.response.amount);
        this.loginService.setCountry(this.response.country);
        this.loginService.setPeriod(this.response.period);
        this.loginService.setExpiry(this.response.expiry);
      },
      err => {
        // this.toastr.error(err);
        this.payment_success = 2 ; 
