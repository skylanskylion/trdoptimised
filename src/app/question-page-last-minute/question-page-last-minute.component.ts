...
@Component({
  selector: 'app-question-page-last-minute',
  templateUrl: './question-page-last-minute.component.html',
  styleUrls: ['./question-page-last-minute.component.css']
})
export class QuestionPageLastMinuteComponent implements OnInit {
  ...
  ngOnInit() {
    this.kp1_model.response_type = 'last-minute'; 
