...
@Component({
  selector: 'app-csicon2019-edit-slot',
  templateUrl: './csicon2019-edit-slot.component.html',
  styleUrls: ['./csicon2019-edit-slot.component.css']
})
export class Csicon2019EditSlotComponent implements OnInit {
