...
@Component({
  selector: 'app-eventlast-word-single',
  templateUrl: './eventlast-word-single.component.html',
  styleUrls: ['./eventlast-word-single.component.css']
})
export class EventlastWordSingleComponent implements OnInit {
  catagory: any;
    slug: string;
    id: any;
    users: any;
