...
@Component({
  selector: 'app-single-benefits-of-yoga3',
  templateUrl: './single-benefits-of-yoga3.component.html',
  styleUrls: ['./single-benefits-of-yoga3.component.css']
})
export class SingleBenefitsOfYoga3Component implements OnInit {
  slug: string;
  id: any;
  users: any;
  event:any;
...
@Component({
  selector: 'app-single-popup3',
  templateUrl: 'single-popup3.html',
})
export class SinglePopup3 implements OnInit{
  ...
  constructor(
      ...
      public dialogRef: MatDialogRef<SinglePopup3>,
