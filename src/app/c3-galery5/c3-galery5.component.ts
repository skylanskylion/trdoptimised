...
@Component({
  selector: 'app-c3-galery5',
  templateUrl: './c3-galery5.component.html',
  styleUrls: ['./c3-galery5.component.css']
})
export class C3Galery5Component implements OnInit {
    slug: string;
    id: any;
    users: any;
...
@Component({
    selector: 'app-single-popup6',
    templateUrl: 'single-popup6.html',
})
export class SinglePopup6 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SinglePopup6>,
