...
@Component({
  selector: 'app-live-updates-main-dashboard',
  templateUrl: './live-updates-main-dashboard.component.html',
  styleUrls: ['./live-updates-main-dashboard.component.css']
})
export class LiveUpdatesMainDashboardComponent implements OnInit {
  model: any = {};
  loading = false;
  sumodel: any = {};
  uploadedfile : any;
