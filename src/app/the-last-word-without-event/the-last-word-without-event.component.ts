...
@Component({
  selector: 'app-the-last-word-without-event',
  templateUrl: './the-last-word-without-event.component.html',
  styleUrls: ['./the-last-word-without-event.component.css']
})
export class TheLastWordWithoutEventComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //  this.route.params.subscribe(params => {
        this.last_word("rssdi-ahmedabad-2018");
        
      this.event = "rssdi-ahmedabad-2018";
  //    })
  ...
  last_word(event) {
      ...
      this.CatagoryService.event_last_word(event).subscribe(
         ...
         //     console.log('CONV URL IS -----------: ', +this.conv[0]['url']);
          }
      );
  }
