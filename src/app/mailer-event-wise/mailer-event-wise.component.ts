...
@Component({
  selector: 'app-mailer-event-wise',
  templateUrl: './mailer-event-wise.component.html',
  styleUrls: ['./mailer-event-wise.component.css']
})

export class MailerEventWiseComponent implements OnInit {
  ...
  send_email() {
    ...
    console.log(f_d);
    this.service.send_email_event(f_d).subscribe(
      data => {
        console.log(data);
      }
    )
