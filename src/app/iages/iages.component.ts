...
@Component({
  selector: 'app-iages',
  templateUrl: './iages.component.html',
  styleUrls: ['./iages.component.css']
})
export class IagesComponent implements OnInit {
    [x: string]: any;
...
notify(){
        ...
        data=>{
          //console.log(data);
            ...
            if(data['success']){
                ...
                this.dialog.open(IagesPollsComponent, dialogConfig);
                ...
                this.dialog.open(IagesQuestionAttemptedPopUp, dialogConfig);
  ...
  @Component({
    selector: 'app-iages',
    templateUrl: './iages-notification.app.component.html',
    styleUrls: ['./iages-notification.app.component.css'] 
  })
 export class IagesNotificationComponent{
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <IagesNotificationComponent >, private router: Router,private dialog: MatDialog) { }
  ...
  @Component({
    selector: 'app-iages',
    templateUrl: './iages-polls-component.html',
    styleUrls: ['./iages-polls-component.css']
  })
 export class IagesPollsComponent {
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <IagesPollsComponent >, private router: Router,private dialog: MatDialog) { }
  // export class QuizPopupComponent {
    //constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <QuizPopupComponent >, private router: Router,private dialog: MatDialog) { }
  dclose(){
  ...
  @Component({
    selector: 'app-iages',
    templateUrl: './iages-polls-attempted-component.html',
    styleUrls: ['./iages-polls-attempted-component.css']
  })
 export class IagesQuestionAttemptedPopUp {
    constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <IagesPollsComponent >, private router: Router,private dialog: MatDialog) { }
  // export class QuizPopupComponent {
    //constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <QuizPopupComponent >, private router: Router,private dialog: MatDialog) { }
  dclose(){
