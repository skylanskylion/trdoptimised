...
@Component({
  selector: 'app-single-yoga-of-wccpc',
  templateUrl: './single-yoga-of-wccpc.component.html',
  styleUrls: ['./single-yoga-of-wccpc.component.css']
})
export class SingleYogaOfWccpcComponent implements OnInit {
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: Object,
        ...
        if(this.users==null){
            this.dialog.open(SingleYogaPopup, {
                width: '600px',
                // height: '250px',
...
@Component({
    selector: 'single-yoga-popup',
    templateUrl: 'single-yoga-popup.html',
})
export class SingleYogaPopup implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SingleYogaPopup>,
