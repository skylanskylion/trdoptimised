...
@Component({
  selector: 'app-ask-questions-faq',
  templateUrl: './ask-questions-faq.component.html',
  styleUrls: ['./ask-questions-faq.component.css']
})
export class AskQuestionsFaqComponent implements OnInit {
  [x: string]: any;
...
mail_check() {
 ...
 // alert('iN IF')
  ...
  response_form(){
    ...
    const data =  JSON.stringify(this.model2);
    console.log("Model :" , this.model2)
    this.user.covid_interview(data).subscribe(data => {
        if (data['status'] == 200) {
          // console.log(data1);
...
//               this.dialog.open(AocMumbaiPollsComponent, dialogConfig);
...
//               this.dialog.open(AocMumbaiQuestionAttemptedPopUp, dialogConfig);
...
//   this.user.submit_form(this.model2).subscribe(); 
...
//  @Component({
//   selector: 'app-aoc-mumbai',
//   templateUrl: './aoc-mumbai-polls-component.html',
//   styleUrls: ['./aoc-mumbai-polls-component.css']
// })
// export class AocMumbaiPollsComponent {
//   constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <AocMumbaiPollsComponent >, private router: Router,private dialog: MatDialog) { }
...
// @Component({
//   selector: 'app-aoc-mumbai',
//   templateUrl: './aoc-mumbai-polls-attempted-component.html',
//   styleUrls: ['./aoc-mumbai-polls-attempted-component.css']
// })
// export class AocMumbaiQuestionAttemptedPopUp {
//   constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <AocMumbaiPollsComponent >, private router: Router,private dialog: MatDialog) { }
// // export class QuizPopupComponent {
//   //constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <QuizPopupComponent >, private router: Router,private dialog: MatDialog) { }
// dclose(){
...
// @Component({
//   selector: 'app-aoc-mumbai',
//   templateUrl: './aoc-notification.app.component.html',
//   styleUrls: ['./aoc-notification.app.component.css'] 
// })
// export class AocNotificationComponent{
//   constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <AocNotificationComponent >, private router: Router,private dialog: MatDialog) { }
// // export class QuizPopupComponent {
//   //constructor( @Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef  <QuizPopupComponent >, private router: Router,private dialog: MatDialog) { }
// dclose(){
//   this.dialog.closeAll();
