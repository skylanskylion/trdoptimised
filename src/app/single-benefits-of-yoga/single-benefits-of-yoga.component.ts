...
@Component({
  selector: 'app-single-benefits-of-yoga',
  templateUrl: './single-benefits-of-yoga.component.html',
  styleUrls: ['./single-benefits-of-yoga.component.css']
})
export class SingleBenefitsOfYogaComponent implements OnInit {
  slug: string;
  id: any;
    event:any;
    users: any;
...
export class SinglePopup implements OnInit{
