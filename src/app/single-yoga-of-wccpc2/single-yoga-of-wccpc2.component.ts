...
@Component({
  selector: 'app-single-yoga-of-wccpc2',
  templateUrl: './single-yoga-of-wccpc2.component.html',
  styleUrls: ['./single-yoga-of-wccpc2.component.css']
})
export class SingleYogaOfWccpc2Component implements OnInit {
    slug: string;
    id: any;
    users: any;
    event:any;
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: Object,
        ...
        if(this.users==null){
            this.dialog.open(SingleYogaPopup2, {
                width: '600px',
                // height: '250px',
...
@Component({
    selector: 'single-yoga-popup2',
    templateUrl: 'single-yoga-popup2.html',
})
export class SingleYogaPopup2 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SingleYogaPopup2>,
