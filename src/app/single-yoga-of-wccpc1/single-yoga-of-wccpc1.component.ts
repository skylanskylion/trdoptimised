...
@Component({
  selector: 'app-single-yoga-of-wccpc1',
  templateUrl: './single-yoga-of-wccpc1.component.html',
  styleUrls: ['./single-yoga-of-wccpc1.component.css']
})
export class SingleYogaOfWccpc1Component implements OnInit {
    slug: string;
    id: any;
    users: any;
    event:any;
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: Object,
        ...
        if(this.users==null){
            this.dialog.open(SingleYogaPopup1, {
                width: '600px',
                // height: '250px',
...
@Component({
    selector: 'single-yoga-popup1.html',
    templateUrl: 'single-yoga-popup1.html',
})
export class SingleYogaPopup1 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SingleYogaPopup1>,
