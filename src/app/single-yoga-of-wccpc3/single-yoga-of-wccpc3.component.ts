...
@Component({
  selector: 'app-single-yoga-of-wccpc3',
  templateUrl: './single-yoga-of-wccpc3.component.html',
  styleUrls: ['./single-yoga-of-wccpc3.component.css']
})
export class SingleYogaOfWccpc3Component implements OnInit {
    slug: string;
    id: any;
    users: any;
    event:any;
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: Object,
        ...
        if(this.users==null){
            this.dialog.open(SingleYogaPopup3, {
                width: '600px',
                // height: '250px',
...
@Component({
    selector: 'single-yoga-popup3',
    templateUrl: 'single-yoga-popup3.html',
})
export class SingleYogaPopup3 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SingleYogaPopup3>,
