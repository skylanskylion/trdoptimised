...
@Component({
  selector: 'app-iages-live-updates-form',
  templateUrl: './iages-live-updates-form.component.html',
  styleUrls: ['./iages-live-updates-form.component.css']
})
export class IagesLiveUpdatesFormComponent implements OnInit {
  model: any = {};
  loading = false;
  sumodel: any = {};
  uploadedfile : any;
