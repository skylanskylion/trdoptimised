...
@Component({
  selector: 'app-podcast-mail',
  templateUrl: './podcast-mail.component.html',
  styleUrls: ['./podcast-mail.component.css']
})
export class PodcastMailComponent implements OnInit {
  article_url: string;
  allarticles: any;
 event: any;
 category: any;
 ...
 ngOnInit() {
   ...
   this.pp=false;
   this.wccmm = false;
   this.article_url = 'https://therightdoctors.com/api/beta/podcast_mail?key=7xOyNH554tY83cBN7Ktpw3s1y68ql6Eg';
 ...
 send_email() {
   ...
   console.log(f_d);
   this.service.send_podcast_email(f_d).subscribe(
     data => {
       console.log(data);
     }
   )
