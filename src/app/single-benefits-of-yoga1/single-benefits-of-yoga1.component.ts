...
@Component({
  selector: 'app-single-benefits-of-yoga1',
  templateUrl: './single-benefits-of-yoga1.component.html',
  styleUrls: ['./single-benefits-of-yoga1.component.css']
})
export class SingleBenefitsOfYoga1Component implements OnInit {
  slug: string;
  id: any;
  users: any;
  event:any;
...
@Component({
  selector: 'app-single-popup1',
  templateUrl: 'single-popup1.html',
})
export class SinglePopup1 implements OnInit{
  ...
  constructor(
      ...
      public dialogRef: MatDialogRef<SinglePopup1>,
