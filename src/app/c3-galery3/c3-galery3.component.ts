...
@Component({
  selector: 'app-c3-galery3',
  templateUrl: './c3-galery3.component.html',
  styleUrls: ['./c3-galery3.component.css']
})
export class C3Galery3Component implements OnInit {
    ...
    constructor(@Inject(PLATFORM_ID) private platformId: Object,
        ...
        if(this.users==null){
            ...
            this.username = JSON.parse(JSON.stringify(this.username['data'][0]['doctor_fname']))+" "+JSON.parse(JSON.stringify(this.username['data'][0]['doctor_lname']));
        }
    }
...
@Component({
    selector: 'app-single-popup4',
    templateUrl: 'single-popup4.html',
})
export class SinglePopup4 implements OnInit{
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<SinglePopup4>,
